...
export default function Checkout() {
    ...
    <div className="space-y-12">
        ...
        <button type="button" className="rounded-md text-sm/6 bg-slate-100 hover:bg-slate-200 px-3 py-2 font-semibold text-gray-900">
          Reset
        </button>
        <button
          type="submit"
...
Choose from exisitng address
        </p>
        <ul role="list" className="divide-y divide-gray-100">
      {addresses.map((address) => (
        <li key={address.phone} className="flex justify-between gap-x-6 py-5 px-5">
...
<div className="flex mt-12 flex-col bg-white shadow-xl">
                            ...
                            {products.map((product) => (
                                <li key={product.id} className="flex py-6">
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col">
                                        ...
                                        <label htmlFor="quantity" className="inline text-sm/6 font-medium text-gray-900 mr-5">Qty</label>
