...
import {productId,productState} from '../../store/atom/list/'
...
export default function ProductDetails() {
  ...
  useEffect(() => {
    if (id) {
      setProductId(id);  // Dynamically set the ID in the atom
    }
  }, [id, setProductId]);


  // Todo --> In server data we will add colors,sizes etc.
  // console.log("product is -->",product.images[0])
   return (product==null || Object.keys(product).length===0)?null:(
